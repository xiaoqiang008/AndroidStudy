...
public class BezierCurveThreeView extends View {
    ...
    public BezierCurveThreeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initPaint();
    }

    public BezierCurveThreeView(Context context, AttributeSet attrs, int defStyleAttr) {
